...
function DockIcon({ 
  ...
  return (
    <div className="relative group flex items-center" style={{ height: '48px' }}>
      ...
      <div 
        className="absolute -top-14 left-1/2 transform -translate-x-1/2 mb-2 px-2 py-1 bg-black/90 text-white text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none"
        style={{ zIndex: 10000 }}
      >
        {label} 
      </div>
